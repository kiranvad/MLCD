...
if noticks
    for i=1:length(l)
        htick(i,1)=text(l(i),-0.045,num2str(l(i)),'Interpreter','latex','FontSize',20);
        htick(i,3)=text(1-l(i)*cos(pi/3)+0.015,l(i)*sin(pi/3)+0.025,num2str(l(i)),'Interpreter','latex','FontSize',20);
        htick(i,2)=text(0.41-l(i)*cos(pi/3)-0.04,sin(pi/3)*(1-l(i)),num2str(l(i)),'Interpreter','latex','FontSize',20); %left mostend
    end
end
hold off
axis image
