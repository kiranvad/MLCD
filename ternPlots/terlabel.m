...
if nargout >= 1
    ...
    text(0.45,-0.095,label2,'horizontalalignment','center','FontSize',20,'Interpreter','latex');
    text(0.12,sqrt(3)/4+0.1,label1,'horizontalalignment','center','rotation',60,'FontSize',20,'Interpreter','latex');
    text(0.88,sqrt(3)/4+0.1,label3,'horizontalalignment','center','rotation',-60,'FontSize',20,'Interpreter','latex');
end